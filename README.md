...
01_generate_missingness.ipynb – builds MCAR/MAR/MNAR masks and writes the post-missingness datasets.

02_run_imputations.ipynb – runs all imputers and writes imputed datasets (ZIPs such as MICE(PMM)_MNAR.zip, AE_MCAR.zip, …).

03_assessment.ipynb – computes NRMSD, Rubin-combined −log10(P), AUC, and produces statistics*.csv and figures.
